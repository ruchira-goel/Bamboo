...
class MealRecommend extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      userId: '',
    ...
    fetch(
      Platform.OS === 'android'
        ? `${
          ...
          }/User/getSavedRecommendationValues?userId=${userId}`
        : `${
            Constants.URL.ios
          }/User/getSavedRecommendationValues?userId=${userId}`,
    )
...
export default function(props) {
  ...
  return <MealRecommend {...props} navigation={navigation} route={route} />;
}
