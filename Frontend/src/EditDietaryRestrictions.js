...
export default class EditDietaryRestrictions extends Component {
  constructor(props) {
    super(props);
    this.state = {
      allergies: [],
  ...
  UNSAFE_componentWillMount(): void {
    ...
    fetch(
      Platform.OS === 'android'
        ...
        : `http://localhost:8080/User/getDietaryRestrictions?userId=${userId}`,
    )
      .then(res => res.json())
      .then(data => {
        this.setState({
  ...
  onSave = () => {
    ...
    fetch(
      Platform.OS === 'android'
        ? `http://10.0.2.2:8080/User/saveDietaryRestrictions?userId=${userId}&allergies=${allergies}&diet=${diet}`
        : `http://localhost:8080/User/saveDietaryRestrictions?userId=${userId}&allergies=${allergies}&diet=${diet}`,
    )
      .then(res => res.json())
      .then(data => {
        if (data.error) {
